...
public final class ContainerSerializationHelper {
     ...
     * @see net.minecraft.world.inventory.PlayerEnderChestContainer#storeAsSlots(ValueOutput.TypedOutputList)
     */
    public static void storeAsSlots(NonNullList<ItemStack> items, ValueOutput.TypedOutputList<ItemStackWithSlot> typedOutputList) {
        storeAsSlots(SlotsProvider.of(items), typedOutputList);
    }
     ...
     * @see net.minecraft.world.inventory.PlayerEnderChestContainer#fromSlots(ValueInput.TypedInputList)
     */
    public static void fromSlots(NonNullList<ItemStack> items, ValueInput.TypedInputList<ItemStackWithSlot> typedInputList) {
        fromSlots(SlotsProvider.of(items), typedInputList);
    }
